          ...
          <table class="table table-bordered table-stripe">
			    ...
			    @foreach (App\Cart::totalCarts() as $cart)
			    	...
			    	<tr>
			    		...
			    		<td> <a href="{{ route('product.show',$cart->product->slug) }}"> {{$cart->product->title }} </td> </a>  
			    		...
			    		<td> 
			    			 ...
			    			 @if ($cart->product->images->count() > 0)
			    			 	<img src="{{ asset('images/products/'. $cart->product->images->first()->image) }}" width="60px" height="50px">
			    			 @endif
